  ...
  return (
    <section className="w-full bg-[var(--color-paper)]">
      <div className="mx-auto flex w-full max-w-[1200px] flex-col items-center gap-8 px-6 py-10 sm:px-10 sm:py-16">
        <h2 className="max-w-[640px] text-center text-[24px] leading-[1.3] font-bold tracking-[-0.4px] text-[var(--color-slate-900)] sm:text-[30px] sm:leading-[1.33]">
          70% Of Roofer&apos;s Have A Lead Source Problem, Here&apos;s Why
        </h2>
        ...
        {/* Closing line + prominent DFY line */}
        <div className="flex max-w-[560px] flex-col items-center gap-2 text-center">
          <p className="text-[18px] leading-[1.5] text-[var(--color-slate-900)]">
            We make sure you&apos;re the one they find - and the one they call.
          </p>
          <p className="text-[24px] leading-[1.3] font-bold text-[var(--color-slate-900)] sm:text-[30px]">
            Done-For-You.
          </p>
        </div>
      </div>
